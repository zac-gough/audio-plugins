...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout()
{
    ...
    //layout.add(std::make_unique<juce::AudioParameterFloat> ("Peak Q", "Peak Q", juce::NormalisableRange<float>(0.1f, 10.f, 0.05f, 1.f), 1.0f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat> ("Signal Smash", "Signal Smash", juce::NormalisableRange<float>(1.f, 10.f, 0.01f, 1.f), 1.f));
