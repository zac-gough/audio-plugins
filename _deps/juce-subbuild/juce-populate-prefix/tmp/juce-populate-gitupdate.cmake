...
execute_process(
  COMMAND "/usr/bin/git" show-ref "origin/develop"
  WORKING_DIRECTORY "/Users/zacgough/Documents/CodingStuff/plugin-experimentation/_deps/juce-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("origin/develop" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/origin/develop")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/zacgough/Documents/CodingStuff/plugin-experimentation/_deps/juce-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/zacgough/Documents/CodingStuff/plugin-experimentation/_deps/juce-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
